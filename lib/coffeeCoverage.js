...
(function() {
  ...
  var CoverageError, EXTENSIONS, INSTRUMENTORS, NodeWrapper, SkipVisitor, _, assert, coffee1, coffee2, events, excludeFile, factoryDefaults, fs, getInstrumentorClass, mkdirs, path, statFile, util;
  ...
  exports._runInstrumentor = function(instrumentor, fileName, source, options = {}) {
    var answer, ast, coffeeOptions, err, fileExtension, init, js, ref, ref1, runVisitor, token, tokens, wrappedAST;
